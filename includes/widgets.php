...
class EDD_Download_Info_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $instance['show_demo_link'] && !empty( $download_demo_link ) ) { ?>
			...
			<a href="<?php echo $download_demo_link; ?>" title="<?php _e( 'Demo', 'edd-download-info' ); ?>" class="<?php echo $style . ' ' . $color . ' edd-submit edd-demo-link'; ?>" target="<?php echo $open; ?>"><?php _e( 'Demo', 'edd-download-info' ); ?></a>
		...
		if ( !empty( $download_demo_link ) && !$instance['show_demo_link'] ) { ?>
			...
			<li><a href="<?php echo $download_demo_link; ?>" class="edd-demo-link" title="<?php _e( 'Demo', 'edd-download-info' ); ?>" target="<?php echo $open; ?>"><?php _e( 'Demo', 'edd-download-info' ); ?></a></li>
		...
		if ( !empty( $download_doc_link ) ) { ?>
			...
			<li><a href="<?php echo $download_doc_link; ?>" class="edd-documentation-link" title="<?php _e( 'Documentation', 'edd-download-info' ); ?>"><?php _e( 'Documentation', 'edd-download-info' ); ?></a></li>

		<?php }

		/* If repository link is set, echo it. */
		if ( !empty( $download_repo_link ) ) { ?>

			<li><a href="<?php echo $download_repo_link; ?>" class="edd-repository-link" title="<?php _e( 'Repository', 'edd-download-info' ); ?>"><?php _e( 'Repository', 'edd-download-info' ); ?></a></li>
		...
		if ( !empty( $download_changelog_link ) ) { ?>
			...
			<li><a href="<?php echo $download_changelog_link; ?>" class="edd-changelog-link" title="<?php _e( 'Changelog', 'edd-download-info' ); ?>"><?php _e( 'Changelog', 'edd-download-info' ); ?></a></li>
