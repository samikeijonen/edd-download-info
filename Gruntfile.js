    ...
    makepot: {
      target: {
        options: {
          ...
          exclude: ['build/.*'],
          mainFile: 'edd-download-info.php',    // Main project file.
          potFilename: 'edd-download-info.pot',    // Name of the POT file.
          potHeaders: {
          ...
          processPot: function( pot, options ) {
            pot.headers['report-msgid-bugs-to'] = 'https://foxland.fi/';
